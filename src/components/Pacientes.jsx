...
const Pacientes = ({paciente, setPaciente, eliminarPaciente}) => {
  ...
  return (
    <div className="mx-3  bg-white my-3 shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex justify-between mt-10">
                ...
                onClick={handleEliminar} //no lo coloco handleEliminar() por que los parentesis ejecutan inmediatamente la funcion
                >Eliminar</button>
            </div>
        </div>
  )
